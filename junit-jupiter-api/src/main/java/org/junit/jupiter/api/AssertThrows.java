...
/**
* {@code AssertThrows} is a collection of utility methods that support asserting an exception of an
...
class AssertThrows {
	...
	static <T extends Throwable> T assertThrows(Class<T> expectedType, Executable executable) {
		...
		throw new AssertionFailedError(
				String.format(
						"Expected %s to be thrown, but nothing was thrown.", getCanonicalName(expectedType)));
	}
}
