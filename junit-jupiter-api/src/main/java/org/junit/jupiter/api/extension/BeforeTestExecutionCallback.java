...
/**
* {@code BeforeTestExecutionCallback} defines the API for {@link Extension Extensions} that wish to
* provide additional behavior to tests immediately before each test is executed.
*
* <p>Such callbacks will be invoked after any user defined setup methods (e.g., {@link
* org.junit.jupiter.api.BeforeEach @BeforeEach} methods).
*
* <p>Concrete implementations often implement {@link AfterTestExecutionCallback} as well.
*
