...
/**
* {@code Assumptions} is a collection of utility methods that support conditional test execution
* based on <em>assumptions</em>.
*
* <p>In direct contrast to failed {@linkplain Assertions assertions}, failed assumptions do not
* result in a test <em>failure</em>; rather, a failed assumption results in a test being
* <em>aborted</em>.
*
* <p>Assumptions are typically used whenever it does not make sense to continue execution of a
* given test method &mdash; for example, if the test depends on something that does not exist in
...
public final class Assumptions {
	...
	*
	* @param assumptionSupplier the supplier of the assumption to validate
	* @param message the message to be included in the {@code TestAbortedException} if the assumption
	*     is invalid
	* @throws TestAbortedException if the assumption is not {@code true}
	*/
	...
	*
	* @param assumption the assumption to validate
	* @param messageSupplier the supplier of the message to be included in the {@code
	*     TestAbortedException} if the assumption is invalid
	* @throws TestAbortedException if the assumption is not {@code true}
	*/
	...
	*/
	public static void assumeTrue(
			BooleanSupplier assumptionSupplier, Supplier<String> messageSupplier)
			throws TestAbortedException {
	...
	*
	* <p>If the {@code executable} throws an exception, it will be rethrown <em>as is</em> but {@link
	* ExceptionUtils#throwAsUncheckedException masked} as an unchecked exception.
	*
	* @param assumptionSupplier the supplier of the assumption to validate
