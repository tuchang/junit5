...
/**
* {@code BeforeAllCallback} defines the API for {@link Extension Extensions} that wish to provide
* additional behavior to test containers before all tests are invoked.
*
