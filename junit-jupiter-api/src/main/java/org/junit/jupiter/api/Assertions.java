...
*
* <p>Unless otherwise noted, a <em>failed</em> assertion will throw an {@link
* org.opentest4j.AssertionFailedError} or a subclass thereof.
*
* @since 5.0
...
public final class Assertions {
	...
	/**
	* <em>Fails</em> a test with the given failure {@code message} as well as the underlying {@code
	* cause}.
	*/
	...
	/**
	* <em>Fails</em> a test with the failure message retrieved from the given {@code
	* messageSupplier}.
	*/
	...
	* <em>Asserts</em> that the supplied {@code condition} is {@code true}.
	*
	* <p>If necessary, the failure message will be retrieved lazily from the supplied {@code
	* messageSupplier}.
	*/
	...
	/**
	* <em>Asserts</em> that the boolean condition supplied by {@code booleanSupplier} is {@code
	* true}.
	*/
	...
	*/
	...
	/**
	* <em>Asserts</em> that the boolean condition supplied by {@code booleanSupplier} is not {@code
	* true}.
	*/
	...
	*/
	public static void assertFalse(
			BooleanSupplier booleanSupplier, Supplier<String> messageSupplier) {
	...
	* <em>Asserts</em> that {@code expected} and {@code actual} are equal.
	*
	* <p>Equality imposed by this method is consistent with {@link Float#equals(Object)} and {@link
	...
	*/
	...
	/**
	* <em>Asserts</em> that {@code expected} and {@code actual} are equal within the given {@code
	* delta}.
	*
	* <p>Equality imposed by this method is consistent with {@link Float#equals(Object)} and {@link
	* Float#compare(float, float)}.
	...
	* <em>Asserts</em> that {@code expected} and {@code actual} are equal.
	*
	* <p>Equality imposed by this method is consistent with {@link Double#equals(Object)} and {@link
	...
	*/
	public static void assertArrayEquals(
			char[] expected, char[] actual, Supplier<String> messageSupplier) {
		AssertArrayEquals.assertArrayEquals(expected, actual, messageSupplier);
	}
	...
	*/
	public static void assertArrayEquals(
			byte[] expected, byte[] actual, Supplier<String> messageSupplier) {
		AssertArrayEquals.assertArrayEquals(expected, actual, messageSupplier);
	}
	...
	*/
	public static void assertArrayEquals(
			int[] expected, int[] actual, Supplier<String> messageSupplier) {
		AssertArrayEquals.assertArrayEquals(expected, actual, messageSupplier);
	}
	...
	*/
	public static void assertArrayEquals(
			long[] expected, long[] actual, Supplier<String> messageSupplier) {
		AssertArrayEquals.assertArrayEquals(expected, actual, messageSupplier);
	}
	...
	*/
	...
	/**
	* <em>Asserts</em> that {@code expected} and {@code actual} float arrays are equal within the
	* given {@code delta}.
	*
	* <p>Equality imposed by this method is consistent with {@link Float#equals(Object)} and {@link
	* Float#compare(float, float)}.
	...
	*/
	public static void assertArrayEquals(
			float[] expected, float[] actual, float delta, String message) {
	...
	*/
	...
	/**
	* <em>Asserts</em> that {@code expected} and {@code actual} double arrays are equal within the
	* given {@code delta}.
	*
	* <p>Equality imposed by this method is consistent with {@link Double#equals(Object)} and {@link
	* Double#compare(double, double)}.
	...
	*/
	public static void assertArrayEquals(
			double[] expected, double[] actual, double delta, String message) {
		AssertArrayEquals.assertArrayEquals(expected, actual, delta, message);
	}
	...
	* this means that the iterables <em>do not</em> need to be of the same type. Example:
	*
	* <pre>{@code
	...
	*
	* <p>Similarly to the check for deep equality in {@link #assertArrayEquals(Object[], Object[],
	* String)}, if two iterables are encountered (including {@code expected} and {@code actual}) then
	* their iterators must return equal elements in the same order as each other.
	* <strong>Note:</strong> this means that the iterables <em>do not</em> need to be of the same
	* type. Example:
	*
	* <pre>{@code
	* import static java.util.Arrays.asList;
	...
	*/
	public static void assertIterableEquals(
			Iterable<?> expected, Iterable<?> actual, String message) {
	...
	*
	* <p>Similarly to the check for deep equality in {@link #assertArrayEquals(Object[], Object[],
	* Supplier)}, if two iterables are encountered (including {@code expected} and {@code actual})
	* then their iterators must return equal elements in the same order as each other.
	* <strong>Note:</strong> this means that the iterables <em>do not</em> need to be of the same
	* type. Example:
	*
	* <pre>{@code
	...
	*/
	public static void assertIterableEquals(
			Iterable<?> expected, Iterable<?> actual, Supplier<String> messageSupplier) {
	...
	*/
	public static void assertNotEquals(
			Object unexpected, Object actual, Supplier<String> messageSupplier) {
	...
	*/
	...
	/**
	* <em>Asserts</em> that <em>all</em> supplied {@code executables} do not throw an {@link
	* AssertionError}.
	*
	* <p>See Javadoc for {@link #assertAll(String, Stream)} for an explanation of this method's
	...
	* AssertionError}.
	*
	* <p>If any supplied {@link Executable} throws an {@code AssertionError}, all remaining {@code
	* executables} will still be executed, and all failures will be aggregated and reported in a
	* {@link MultipleFailuresError}. However, if an {@code executable} throws an exception that is
	* not an {@code AssertionError}, execution will halt immediately, and the exception will be
	* rethrown <em>as is</em> but {@link ExceptionUtils#throwAsUncheckedException masked} as an
	* unchecked exception.
	*
	* <p>The supplied {@code heading} will be included in the message string for the {@link
	...
	*
	* <p>If no exception is thrown, or if an exception of a different type is thrown, this method
	* will fail.
	*
	* <p>If you do not want to perform additional checks on the exception instance, simply ignore the
	* return value.
	*/
	...
	/**
	* <em>Asserts</em> that execution of the supplied {@code executable} completes before the given
	* {@code timeout} is exceeded.
	*
	* <p>Note: the {@code executable} will be executed in the same thread as that of the calling
	* code. Consequently, execution of the {@code executable} will not be preemptively aborted if the
	* timeout is exceeded.
	*
	...
	*/
	public static void assertTimeout(
			Duration timeout, Executable executable, Supplier<String> messageSupplier) {
	...
	/**
	* <em>Asserts</em> that execution of the supplied {@code supplier} completes before the given
	* {@code timeout} is exceeded.
	*
	* <p>If the assertion passes then the {@code supplier}'s result is returned.
	*
	* <p>Note: the {@code supplier} will be executed in the same thread as that of the calling code.
	* Consequently, execution of the {@code supplier} will not be preemptively aborted if the timeout
	* is exceeded.
	*
	* @see #assertTimeout(Duration, Executable)
	* @see #assertTimeout(Duration, Executable, String)
	...
	* @see #assertTimeoutPreemptively(Duration, Executable, String)
	*/
	public static <T> T assertTimeout(
			Duration timeout, ThrowingSupplier<T> supplier, String message) {
	...
	* {@code timeout} is exceeded.
	*
	* <p>Note: the {@code executable} will be executed in a different thread than that of the calling
	* code. Furthermore, execution of the {@code executable} will be preemptively aborted if the
	* timeout is exceeded.
	*
	* @see #assertTimeoutPreemptively(Duration, Executable, String)
	* @see #assertTimeoutPreemptively(Duration, Executable, Supplier)
	...
	* @see #assertTimeout(Duration, Executable, String)
	*/
	public static void assertTimeoutPreemptively(
	...
	* <p>If the assertion passes then the {@code supplier}'s result is returned.
	*
	* <p>Note: the {@code supplier} will be executed in a different thread than that of the calling
	* code. Furthermore, execution of the {@code supplier} will be preemptively aborted if the
	* timeout is exceeded.
	*
	* @see #assertTimeoutPreemptively(Duration, Executable)
	* @see #assertTimeoutPreemptively(Duration, Executable, String)
