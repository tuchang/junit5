...
/**
* {@code Executable} is a functional interface that can be used to implement any generic block of
* code that potentially throws a {@link Throwable}.
*
* <p>The {@code Executable} interface is similar to {@link java.lang.Runnable}, except that an
* {@code Executable} can throw any kind of exception.
*
...
* java.lang.AssertionError} (in testing scenarios), there may be use cases where an {@code
* Executable} needs to explicitly throw a {@code Throwable}. In order to support such specialized
...
* @see org.junit.jupiter.api.Assumptions#assumingThat(java.util.function.BooleanSupplier,
*     Executable)
