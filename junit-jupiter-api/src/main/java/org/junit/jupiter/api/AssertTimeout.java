...
/**
* {@code AssertTimeout} is a collection of utility methods that support asserting the execution of
* the code under test did not take longer than the timeout duration.
*
* @since 5.0
*/
class AssertTimeout {
