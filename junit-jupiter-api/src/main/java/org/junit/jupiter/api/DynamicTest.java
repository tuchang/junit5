...
*
* <p>It is composed of a {@linkplain #getDisplayName display name} and an {@link #getExecutable
* Executable}.
*
* <p>Instances of {@code DynamicTest} must be generated by factory methods annotated with {@link
* TestFactory @TestFactory}.
*
* <p>Note that dynamic tests are quite different from standard {@link Test @Test} cases since
* callbacks such as {@link BeforeEach @BeforeEach} and {@link AfterEach @AfterEach} methods are not
* executed for dynamic tests.
*
* @since 5.0
...
public class DynamicTest {
	...
	/**
	* Factory for creating a new {@code DynamicTest} for the supplied display name and executable
	* code block.
	*
	* @param displayName the display name for the dynamic test; never {@code null} or blank
	* @param executable the executable code block for the dynamic test; never {@code null}
	* @see #stream(Iterator, Function, ThrowingConsumer)
	*/
