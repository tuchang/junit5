...
/**
* Implementation core of all {@link TestEngine TestEngines} that wish to use the {@link Node}
* abstraction as the driving principle for structuring and executing test suites.
*
* <p>A {@code HierarchicalTestExecutor} is instantiated by a concrete implementation of {@link
* HierarchicalTestEngine} and takes care of executing nodes in the hierarchy in the appropriate
* order as well as firing the necessary events in the {@link EngineExecutionListener}.
*
...
class HierarchicalTestExecutor<C extends EngineExecutionContext> {
	...
	private void execute(TestDescriptor testDescriptor, C parentContext) {
		...
		TestExecutionResult result =
				singleTestExecutor.executeSafely(
						() -> {
