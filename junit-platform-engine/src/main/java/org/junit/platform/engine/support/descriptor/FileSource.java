...
/**
* File based {@link org.junit.platform.engine.TestSource} with an optional {@linkplain FilePosition
* position}.
*
* @since 1.0
...
public class FileSource implements FileSystemSource {
	...
	*/
	...
	/**
	* Create a new {@code FileSource} using the supplied {@link File file} and {@link FilePosition
	* filePosition}.
	*
	* @param file the source file; must not be {@code null}
