...
*
* <p>A {@code TestExecutionResult} consists of a mandatory {@link Status} and an optional {@link
* Throwable}.
*
* @since 1.0
*/
...
public class TestExecutionResult {
	...
	private static final TestExecutionResult SUCCESSFUL_RESULT =
			new TestExecutionResult(SUCCESSFUL, null);

	/** Status of executing a single test or container. */
	public enum Status {

		/** Indicates that the execution of a test or container was <em>successful</em>. */
		SUCCESSFUL,

		/**
		* Indicates that the execution of a test or container was <em>aborted</em> (started but not
		* finished).
		*/
		ABORTED,

		/** Indicates that the execution of a test or container has <em>failed</em>. */
		FAILED
	}
	...
	/**
	* Obtain a {@code TestExecutionResult} for a <em>successful</em> execution of a test or
	* container.
	*/
	...
	/**
	* Obtain a {@code TestExecutionResult} for an <em>aborted</em> execution of a test or container
	* with the supplied {@link Throwable throwable}.
	*
	...
	*/
	...
	/**
	* Obtain a {@code TestExecutionResult} for a <em>failed</em> execution of a test or container
	* with the supplied {@link Throwable throwable}.
	*
