...
public interface PackageNameFilter extends DiscoveryFilter<String> {
	...
	/**
	* Create a new <em>include</em> {@link PackageNameFilter} based on the supplied package names.
	*
	* <p>The names are combined using OR semantics, i.e. if the fully qualified name of a package
	* starts with at least one of the names, the package will be included in the result set.
	*
	* @param names package names that we be compared against fully qualified package names; never
	*     {@code null}, empty, or containing {@code null}
	* @see Package#getName()
	*/
	...
	*/
	...
	/**
	* Create a new <em>exclude</em> {@link PackageNameFilter} based on the supplied package names.
	*
	* <p>The names are combined using OR semantics, i.e. if the fully qualified name of a package
	* starts with at least one of the names, the package will be excluded in the result set.
	*
	* @param names package names that we be compared against fully qualified package names; never
	*     {@code null}, empty, or containing {@code null}
	* @see Package#getName()
