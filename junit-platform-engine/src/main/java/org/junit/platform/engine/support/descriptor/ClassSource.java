...
/**
* Java class based {@link org.junit.platform.engine.TestSource} with an optional {@linkplain
...
public class ClassSource implements TestSource {
	...
	/**
	* Create a new {@code ClassSource} using the supplied className.
	*
	...
	*/
	...
	/**
	* Create a new {@code ClassSource} using the supplied className and {@link FilePosition
	* filePosition}.
	*
	* @param className the Java class name; must not be {@code null}
	...
	*/
	...
	/**
	* Create a new {@code ClassSource} using the supplied {@link Class javaClass}.
	*
	...
	*/
	...
	/**
	* Create a new {@code ClassSource} using the supplied {@link Class javaClass} and {@link
	...
	*/
	...
	/**
	* Get the {@linkplain FilePosition position} in the Java source file for the associated
	* {@linkplain #getJavaClass Java class}, if available.
	*
	* @see #getJavaClass()
	*/
