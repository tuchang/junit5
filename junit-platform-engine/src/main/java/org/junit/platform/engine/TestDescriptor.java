...
/**
* Mutable descriptor for a test or container that has been discovered by a {@link TestEngine}.
*
* @see TestEngine
* @since 1.0
*/
...
public interface TestDescriptor {
	...
	*
	* <p>Uniqueness must be guaranteed across an entire test plan, regardless of how many engines are
	...
	* characters, and emoji, and the format may be customized by {@link TestEngine TestEngines} or
	...
	*
	* @return the set of tags associated with this descriptor; never {@code null} but potentially
	*     empty
	* @see TestTag
	*/
	Set<TestTag> getTags();
	...
	/**
	* Get the {@linkplain TestSource source} of the test or container described by this descriptor,
	* if available.
	*
	* @see TestSource
	*/
	...
	*
	* @return the set of children of this descriptor; never {@code null} but potentially empty
	* @see #getDescendants()
	*/
	...
	*
	* <p>A <em>descendant</em> is a child of this descriptor or a child of one of its children,
	* recursively.
	*
	* @see #getChildren()
	*/
	...
	*
	* @param descriptor the child to remove from this descriptor; never {@code null}
	*/
	void removeChild(TestDescriptor descriptor);

	/**
	* Remove this non-root descriptor from its parent and remove all the children from this
	* descriptor.
	*
	* <p>If this method is invoked on a {@linkplain #isRoot root} descriptor, this method must throw
	* a {@link org.junit.platform.commons.JUnitException JUnitException} explaining that a root
	...
	*
	* <p>The search algorithm begins with this descriptor and then searches through its descendants.
	*
