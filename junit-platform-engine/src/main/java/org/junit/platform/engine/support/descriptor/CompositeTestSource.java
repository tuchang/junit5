...
public class CompositeTestSource implements TestSource {
	...
	/**
	* Create a new {@code CompositeTestSource} based on the supplied collection of {@link TestSource
	* sources}.
	*
	* <p>This constructor makes a defensive copy of the supplied collection and stores the sources as
	* a list in the order in which they are returned by the collection's iterator.
	*
	* @param sources the collection of sources to store in this {@code CompositeTestSource}; never
	*     {@code null} or empty
	*/
	...
	/**
	* Get an immutable list of the {@linkplain TestSource sources} stored in this {@code
	* CompositeTestSource}.
	*
