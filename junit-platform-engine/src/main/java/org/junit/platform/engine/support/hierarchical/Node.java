...
public interface Node<C extends EngineExecutionContext> {
	...
	*/
	...
	/**
	* Determine if the execution of the supplied {@code context} should be <em>skipped</em>.
	*
	...
	*
	* <p>This method will be called once <em>before</em> {@linkplain #execute execution} of this
	* node.
	*
	...
	*
	* <p>Containers typically do not implement this method since the {@link HierarchicalTestEngine}
	* handles execution of their children.
	*
	* <p>The supplied {@code dynamicTestExecutor} may be used to submit additional dynamic tests for
	* immediate execution.
	*
	* @param context the context to execute in
	* @param dynamicTestExecutor the executor to submit dynamic tests to
	* @return the new context to be used for children of this node and for the <em>after</em>
	*     behavior of the parent of this node, if any
	* @see #before
	* @see #after
	*/
	...
	* @see #before
	* @see #after
	* @deprecated Please use {@link #execute(EngineExecutionContext, DynamicTestExecutor)} instead.
	*/
	@Deprecated
	...
	*
	* <p>This method will be called once <em>after</em> {@linkplain #execute execution} of this node.
	*
	* @param context the context to execute in
	* @see #before
	* @see #execute
	*/
	...
	/**
	* The result of determining whether the execution of a given {@code context} should be
	* <em>skipped</em>.
	*
	...
	*/
	...
	/**
	* Executor for additional, dynamic test descriptors discovered during execution of a {@link
	* Node}.
	*
	* <p>The test descriptors will be executed by the same {@link HierarchicalTestExecutor} that
	* executes the submitting node.
	*
