...
/**
* Simple {@link TestExecutionListener} for logging informational messages for all events via a
* {@link BiConsumer} that consumes {@code Throwable} and {@code Supplier<String>}.
*
* @since 1.0
...
public class LoggingListener implements TestExecutionListener {
	...
	/**
	* Create a {@code LoggingListener} which delegates to a {@link java.util.logging.Logger} using a
	* log level of {@link Level#FINE FINE}.
	*
	* @see #forJavaUtilLogging(Level)
	*/
	...
	/**
	* Create a {@code LoggingListener} which delegates to a {@link java.util.logging.Logger} using
	* the supplied {@linkplain Level log level}.
	*
	...
	*/
	...
	/**
	* Create a {@code LoggingListener} which delegates to the supplied {@link BiConsumer} for
	* consumption of logging messages.
	*
	* @param logger a logger implemented as a {@code BiConsumer}; never {@code null}
	* @see #forJavaUtilLogging()
	* @see #forJavaUtilLogging(Level)
	*/
