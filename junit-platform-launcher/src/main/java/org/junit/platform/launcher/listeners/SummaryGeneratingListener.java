...
/**
* Simple {@link TestExecutionListener} that generates a {@linkplain TestExecutionSummary summary}
...
public class SummaryGeneratingListener implements TestExecutionListener {
	...
	public void executionSkipped(TestIdentifier testIdentifier, String reason) {
		...
		long skippedContainers =
				concat(Stream.of(testIdentifier), testPlan.getDescendants(testIdentifier).stream())
			...
			case FAILED:
				{
					...
					testExecutionResult
							.getThrowable()
							.ifPresent(throwable -> this.summary.addFailure(testIdentifier, throwable));
					break;
				}
