	...
	AvailableOptions() {
		...
		details =
				parser
						.accepts(
								"details",
								"Select an output details mode for when tests are executed. Use one of: "
										+ asList(Details.values())
										+ ". If '"
										+ Details.NONE
		...
		additionalClasspathEntries =
				parser
						.acceptsAll(
								asList(CP_OPTION, "classpath", "class-path"), //
		...
		selectedClasspathEntries =
				parser
						.acceptsAll(
								asList("scan-class-path", "scan-classpath"), //
