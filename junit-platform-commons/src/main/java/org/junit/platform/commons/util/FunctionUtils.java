...
/**
* Collection of utilities for working with {@link Function Functions}, {@link Predicate
* Predicates}, etc.
*
* <h3>DISCLAIMER</h3>
*
...
public final class FunctionUtils {
	...
	/**
	* Returns a predicate that first applies the specified function and then tests the specified
	* predicate against the result of the function.
	*
