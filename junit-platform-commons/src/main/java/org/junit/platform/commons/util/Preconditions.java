...
*
* <p>Each method in this class throws a {@link PreconditionViolationException} if the precondition
* is violated.
*
* <h3>DISCLAIMER</h3>
*
...
public final class Preconditions {
	...
	*
	* <p><strong>WARNING</strong>: this method does NOT check if the supplied array contains any
	* {@code null} elements.
	*
	* @param array the array to check
	* @param message precondition violation message
	* @return the supplied array as a convenience
	* @throws PreconditionViolationException if the supplied array is {@code null} or <em>empty</em>
	...
	*
	* <p><strong>WARNING</strong>: this method does NOT check if the supplied collection contains any
	* {@code null} elements.
	*
	...
	*
	* <p><strong>WARNING</strong>: this method does NOT check if the supplied array is {@code null}
	* or <em>empty</em>.
	*
	* @param array the array to check
	* @param message precondition violation message
	* @return the supplied array as a convenience
	* @throws PreconditionViolationException if the supplied array contains any {@code null} elements
	* @see #notNull(Object, String)
	*/
	public static <T> T[] containsNoNullElements(T[] array, String message)
			throws PreconditionViolationException {
		if (array != null) {
	...
	*
	* <p><strong>WARNING</strong>: this method does NOT check if the supplied collection is {@code
	* null} or <em>empty</em>.
	*
	* @param collection the collection to check
	* @param message precondition violation message
	* @return the supplied collection as a convenience
	* @throws PreconditionViolationException if the supplied collection contains any {@code null}
	*     elements
	* @see #notNull(Object, String)
	*/
	...
	*
	* <p>A {@code String} is <em>blank</em> if it is {@code null} or consists only of whitespace
	* characters.
	*
